...
@section('container')
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('admin.goodins.index') }}" class="mb-4">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-3">
                        <a href="{{ route('admin.goodins.export.pdf', request()->only('start_date', 'end_date')) }}"
                        ...
                        @forelse ($goodsIn as $in)
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('admin.goodins.destroy', $in->id) }}" method="POST"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('admin.goodins.store') }}" method="POST">
                @csrf
